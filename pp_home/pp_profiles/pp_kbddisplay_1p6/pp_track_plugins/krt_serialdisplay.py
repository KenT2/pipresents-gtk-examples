...
class krt_serialdisplay(object):
    ...
    def __init__(self,root,canvas,plugin_params,track_params,show_params,pp_dir,pp_home,pp_profile):
        ...
        # ------ Make an instance of I/O driver manager
    ...
    def show(self):
        ...
        #  Draw objects direct to the screen setting their visibility to True so they are dislayed
        #
        ...
        self.canvas.put(plugin_obj1,100,400)
        plugin_obj1.set_visible(True)
        self.plugin_objects.append(plugin_obj1)
